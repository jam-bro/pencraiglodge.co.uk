    ...
    >
      <div className="shadow-sm">
        <div className="mx-auto max-w-screen-lg  flex justify-between items-center pt-8 pb-4 px-6 2l:px-0">
          ...
          <div className="space-x-4 text-sm lg:text-base text-gray-500 font-semibold">
            <Link href="#contact-us">
              <a className="hover:text-gray-900 hover:border-b-pink-300 hover:border-b  transition ease-in-out duration-300">
                Get in touch
              </a>
            </Link>
          </div>
      ...
      <div className="max-w-screen-lg mx-auto text-gray-700 mb-8">
        {/* Nav */}
            ...
            <div className="mt-4 leading-7 xl:grid grid-cols-2 gap-x-24">
              <div>
                ...
                <p className="mt-2">
                  ...
                  surrounded by fields and woodland. Within walking distance we
                  have a pub, chip shop and small convenience store.
                </p>
                <p className="mt-2">
                  We have a lovely hot tub area, and plenty of grassy garden
                  around the cottage to enable you to sit and enjoy a glass of
                  something nice or to eat outside and for for the children, dog
                  or both to play!
                </p>
                <p className="mt-2">
                  The market town of{' '}
                  ...
                  is a ten minute drive where you can find three supermarkets
                  along with a highstreet lined with shops, cafes, restaurants
                  and pubs.
                </p>
              </div>
          ...
          <div className="xl:mt-12 mt-12" id="contact-us">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2">
                ...
                questions or to help in any way possible! Please don’t be afraid
                to message or email me and I’ll get back to you as soon as I
                can!
              </p>
              <div className="mt-4">
                ...
                <div className="flex items-center mt-4">
                  ...
                  <p className="ml-4">hello@pencraiglodge.co.uk</p>
                </div>
              </div>
            </div>
          </div>

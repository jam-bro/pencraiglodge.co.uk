          ...
          <div className="px-6 2xl:px-0 mt-4">
            <div className="">
              ...
              <div className="flex mt-8 space-x-4">
                  ...
                  <a href="#contact-us" className="flex items-center bg-green-100 text-green-900 hover:bg-green-50 transition duration-300 font-semibold text-sm px-5 py-3 rounded-lg border border-green-900 shadow">
